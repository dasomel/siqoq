...
첫 demo는 synthetic/generated event를 사용하므로 카메라나 accelerator가 없어도 실행할 수 있습니다.
...
Sensor Event, Semantic Event, Action Request 같은 공통 계약을 변경할 때는 다음을 확인합니다.
